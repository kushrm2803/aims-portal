...
export async function PUT(request, { params }) {
  ...
  try {
    ...
    if (course.adminApproval !== "pending") {
      return NextResponse.json({ message: "Course has already been approved or rejected" }, { status: 400 });
    }
    ...
    return NextResponse.json({ message: "Course approved successfully", course });
  } catch (error) {
